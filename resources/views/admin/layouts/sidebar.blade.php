<aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview {{request()->routeIs('admin.brands*') ? 'active' : ""}}">
          <a href="#">
          ...
          <ul class="treeview-menu">
            <li><a href="{{route('admin.brands.index')}}"><i class="ti-more"></i>View</a></li>
          </ul>
        </li>

        <li class="treeview {{request()->routeIs('admin.categories*') ? 'active' : ""}}">
          <a href="#">
          ...
          <ul class="treeview-menu">
            <li><a href="{{route('admin.categories.index')}}"><i class="ti-more"></i>View</a></li>
          </ul>
