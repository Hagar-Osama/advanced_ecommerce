       <!-- Modal -->
       <div class="modal center-modal fade" id="editColor{{$color->id}}" tabindex="-1">
                ...
                <div class="modal-body">
                    <form method="post" action="{{ route('admin.colors.update', $color->id) }}">
                        ...
                        <div class="form-group">
                            ...
                            <div class="controls">
                                <input type="text" name="name[{{$language['locale']}}]" class="form-control"
                                    value="{{ old('name.'.$language["locale"], $color->name->{$language['locale']} )  }}">
                        ...
                        <div class="form-group">
                            ...
                            <div class="controls">
                                <input type="text" name="code" value="{{old('code',$color->code)}}" class="form-control">
                                @error('code')
                                    <span class="alert text-danger"> {{ $message }}</span>
                                @enderror
                            </div>
